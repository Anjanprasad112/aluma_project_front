...
import { close, logo, menu,icons8menu,icons8close } from "../assets";
import { navLinks } from "../constants";
import img from "../assets/img-06.png";
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-3 justify-between items-center navbar">
      ...
      <img src={img} alt="" />
      {/* <h2 className='text-black text-xl font-semibold tracking-normal font-poppins'>Aluma</h2> */}
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        <img
          src={toggle ? icons8close : icons8menu}
          alt="menu"
